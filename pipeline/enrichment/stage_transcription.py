    ...
    return [
        ...
        },
        {
            ...
            "content": (
                ...
                "<sp who=\"#id\">…</sp>, where #id comes from the speaker_directory in the briefing. "
                "The <sp> contains a <speaker> with the literal label ('Q.', 'A.', 'MR. GRINNELL') "
                "and one or more <p> elements with the spoken text. If you cannot identify the "
                "speaker, drop the who attribute but still wrap in <sp>.\n"
    ...
    return [
        ...
        },
        {
            ...
            "content": (
                ...
                "'#' (e.g. '#bonfield', '#mr_grinnell'). null if speaker is null or unidentifiable.\n"
