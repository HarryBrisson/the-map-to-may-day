...
def test_openai_extraction_schema_matches_strict_response_format_subset() -> None:
    schema = llm_extraction.load_openai_extraction_schema()
...
def assert_openai_strict_schema(schema) -> None:
    unsupported_keys = llm_extraction.OPENAI_UNSUPPORTED_SCHEMA_KEYS
...
def test_tei_prompt_includes_speaker_context_and_full_text() -> None:
    page = {
    ...
    chunk = llm_extraction.build_source_chunks(page, "<html>fixture</html>")[0]
    messages = llm_extraction.build_messages(page, chunk)
